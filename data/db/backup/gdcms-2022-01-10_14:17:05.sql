...
CREATE TABLE `rt_admin_oplog` (
  ...
  `addtime` int(10) unsigned DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 590 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理操作日志';
...
VALUES
  (
    'admin',
    '4088dd9a9c4149ffb9353b01a1e554cd',
    1,
    'sJE2GaKJwbnAT5M3',
    0,
    NULL,
