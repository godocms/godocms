...
import {exportJSON} from "../io/JSONSerializer.js";
...
export function createDNDImage(parent, src, title, info) {
    ...
    appendDNDInfo(img, info);
    parent.appendChild(img);
    return img;
}

exportJSON
export function appendDNDInfo(img, info) {
    img.setAttribute("draggable", "true");
    img.setAttribute(DRAGINFO_PREFIX, exportJSON(info, true));
