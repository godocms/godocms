...
window.SAVE_URL = window.SAVE_URL || '/server/flow/add';
...
window.OPEN_FORM = window.OPEN_FORM || '/admin/flow/graph/open.html';
...
window.mxBasePath = window.mxBasePath || '/admin/flow/src';
