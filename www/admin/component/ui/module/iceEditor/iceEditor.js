	...
	class iceEditor {
		constructor(id) {
			...
			this.face = [{
				...
				type: 'img',
				list: [
					{ title: '嘻嘻', content:'/admin/component/form/images/tootha_thumb.gif'},
					{title:'哈哈',content:'/admin/component/form/images/laugh.gif'},
					{title:'可爱',content:'/admin/component/form/images/tza_thumb.gif'},
					{title:'可怜',content:'/admin/component/form/images/kl_thumb.gif'},
					{title:'挖鼻屎',content:'/admin/component/form/images/kbsa_thumb.gif'},
					{title:'吃惊',content:'/admin/component/form/images/cj_thumb.gif'},
					{title:'害羞',content:'/admin/component/form/images/shamea_thumb.gif'},
					{title:'挤眼',content:'/admin/component/form/images/zy_thumb.gif'},
					{title:'闭嘴',content:'/admin/component/form/images/bz_thumb.gif'},
					{title:'鄙视',content:'/admin/component/form/images/bs2_thumb.gif'},
					{title:'爱你',content:'/admin/component/form/images/lovea_thumb.gif'},
					{title:'泪',content:'/admin/component/form/images/sada_thumb.gif'},
					{title:'偷笑',content:'/admin/component/form/images/heia_thumb.gif'},
					{title:'亲亲',content:'/admin/component/form/images/qq_thumb.gif'},
					{title:'生病',content:'/admin/component/form/images/sb_thumb.gif'},
					{title:'太开心',content:'/admin/component/form/images/mb_thumb.gif'},
					{title:'懒得理你',content:'/admin/component/form/images/ldln_thumb.gif'},
					{title:'右哼哼',content:'/admin/component/form/images/yhh_thumb.gif'},
					{title:'左哼哼',content:'/admin/component/form/images/zhh_thumb.gif'},
					{title:'嘘',content:'/admin/component/form/images/x_thumb.gif'},
					{title:'衰',content:'/admin/component/form/images/cry.gif'},
					{title:'委屈',content:'/admin/component/form/images/wq_thumb.gif'},
					{title:'吐',content:'/admin/component/form/images/t_thumb.gif'},
					{title:'打哈欠',content:'/admin/component/form/images/k_thumb.gif'},
					{title:'抱抱',content:'/admin/component/form/images/bba_thumb.gif'},
					{title:'怒',content:'/admin/component/form/images/angrya_thumb.gif'},
					{title:'疑问',content:'/admin/component/form/images/yw_thumb.gif'},
					{title:'馋嘴',content:'/admin/component/form/images/cza_thumb.gif'},
					{title:'拜拜',content:'/admin/component/form/images/88_thumb.gif'},
					{title:'思考',content:'/admin/component/form/images/sk_thumb.gif'},
					{title:'汗',content:'/admin/component/form/images/sweata_thumb.gif'},
					{title:'困',content:'/admin/component/form/images/sleepya_thumb.gif'},
					{title:'睡觉',content:'/admin/component/form/images/sleepa_thumb.gif'},
					{title:'钱',content:'/admin/component/form/images/money_thumb.gif'},
					{title:'失望',content:'/admin/component/form/images/sw_thumb.gif'},
					{title:'酷',content:'/admin/component/form/images/cool_thumb.gif'},
					{title:'花心',content:'/admin/component/form/images/hsa_thumb.gif'},
					{title:'哼',content:'/admin/component/form/images/hatea_thumb.gif'},
					{title:'鼓掌',content:'/admin/component/form/images/gza_thumb.gif'},
					{title:'晕',content:'/admin/component/form/images/dizzya_thumb.gif'},
					{title:'悲伤',content:'/admin/component/form/images/bs_thumb.gif'},
					{title:'抓狂',content:'/admin/component/form/images/crazya_thumb.gif'},
					{title:'黑线',content:'/admin/component/form/images/h_thumb.gif'},
					{title:'阴险',content:'/admin/component/form/images/yx_thumb.gif'},
					{title:'怒骂',content:'/admin/component/form/images/nm_thumb.gif'},
					{title:'心',content:'/admin/component/form/images/hearta_thumb.gif'},
					{title:'伤心',content:'/admin/component/form/images/unheart.gif'},
					{title:'ok',content:'/admin/component/form/images/ok_thumb.gif'},
					{title:'耶',content:'/admin/component/form/images/ye_thumb.gif'},
					{title:'good',content:'/admin/component/form/images/good_thumb.gif'},
					{title:'不要',content:'/admin/component/form/images/no_thumb.gif'},
					{title:'赞',content:'/admin/component/form/images/z2_thumb.gif'},
					{title:'来',content:'/admin/component/form/images/come_thumb.gif'},
					{title:'弱',content:'/admin/component/form/images/sad_thumb.gif'},
					{title:'蜡烛',content:'/admin/component/form/images/lazu_thumb.gif'},
					{title:'蛋糕',content:'/admin/component/form/images/cake.gif'}
				]
			},{
				title: '文字',
				type: 'text',
